...
class AdminXiangguanciController extends AdminBaseController
{
    /**
     * 文章列表
     * @adminMenu(
    ...
    public function index()
    {
        ...
        $data        = $postService->adminXiangguanciList($param);

        $data->appends($param);

        $this->assign('keyword', isset($param['keyword']) ? $param['keyword'] : '');
        $this->assign('guanjianci_id', isset($param['guanjianci_id']) ? $param['guanjianci_id'] : '');
...
//            }
            ...
            $this->success('添加成功!', url('AdminXiangguanci/index', ['guanjianci_id' => $portalPostModel->guanjianci_id]));
        }
...
//        $this->assign('post_category_ids', $postCategoryIds);
        $this->assign('guanjianci_id', isset($post['guanjianci_id']) ? $post['guanjianci_id'] : '');
        return $this->fetch();
    }
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $this->success('保存成功!',url('AdminXiangguanci/index', ['guanjianci_id' => $data['post']['guanjianci_id']]));
    ...
    public function delete()
    {
        ...
        if (isset($param['id'])) {
            ...
            $data         = [
                'object_id'   => $result['id'],
                'create_time' => time(),
                'table_name'  => 'guanjianci_xiangguanci_post',
